...
- **Future proofing:** Microsoft intends to further expand TaskHost support and unify SDK/resolver logic (see [dotnet/msbuild#12895](https://github.com/dotnet/msbuild/issues/12895) for ongoing work).
